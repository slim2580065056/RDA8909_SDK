...
API_PLATFORM_DEPENDS := platform \
                        ...
                        ${PLATFORM_SERVICE}/posix \
                        ${PLATFORM_SERVICE}/aworker \
                        platform/edrv/atvd  \
...
API_PLATFORM_DEPENDS += ${PLATFORM_SERVICE}/net/ \
                        ...
                        ${PLATFORM_SERVICE}/net/http \
                        ${PLATFORM_SERVICE}/net/mupnp/src/mupnp \
                        ${PLATFORM_SERVICE}/net/mbedtls/src/mbedtls \
                        ${PLATFORM_SERVICE}/net/xmlparser \
                        ${PLATFORM_SERVICE}/net/liblwm2m \
                        ${PLATFORM_SERVICE}/net/libcoap \
                        ${PLATFORM_SERVICE}/net/libmqttsn \
                        ${PLATFORM_SERVICE}/net/aliotx \
                        ${PLATFORM_SERVICE}/net/edp
endif
