...
ifeq "${CT_USER}" "ADMIN"
    ...
    TEAM_BINARY_LIBS += ${PLATFORM_SERVICE}/fota/packed
    TEAM_BINARY_LIBS += ${PLATFORM_SERVICE}/sffs/packed
    TEAM_BINARY_LIBS += ${PLATFORM_SYSTEM}/stack/packed
    TEAM_BINARY_LIBS += ${PLATFORM_SYSTEM}/nbiot/packed
    TEAM_BINARY_LIBS += application/coolmmi/mmi/wapmms/jcore/packed
    TEAM_BINARY_LIBS += toolpool/blfpc/goke_flash_tool/packed
    TEAM_BINARY_LIBS += platform/chip/nbcpu/packed
    TEAM_BINARY_LIBS += platform/chip/bcpu/packed
    TEAM_BINARY_LIBS += platform/chip/patch/packed
endif
