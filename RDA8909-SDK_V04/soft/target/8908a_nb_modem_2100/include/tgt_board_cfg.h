...
// GPIO(37) // KEYIN_3
#define TGT_HAL_GPIO_37_USED AS_ALT_FUNC
// GPIO(38) // KEYIN_4
#define TGT_HAL_GPIO_38_USED AS_GPIO
// =============================================================================
// Chip version
// =============================================================================
...
#define TGT_HAL_USED_GPIO_H     ( \
        ((TGT_HAL_GPIO_37_USED & 1) << 5)   | \
        ((TGT_HAL_GPIO_38_USED & 1) << 6))
...
#include "hal_tcu.h"
#define TGT_XCV_CONFIG                    \
    {                                     \
        .RST = TCO_UNUSED, .PDN = TCO(11) \
    }
#define TGT_PA_CONFIG                                           \
    {                                                           \
        .ENA = TCO_UNUSED, .TXEN = TCO_UNUSED, .BS = TCO_UNUSED \
    }
#define TGT_SW_CONFIG                               \
    {                                               \
        .SW1 = TCO(2), .SW2 = TCO(3), .SW3 = TCO(4) \
    }
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .powerOnVoltageMV            = 2400,                            \
        .powerDownVoltageMV          = 2400,                            \
        ...
        .rfPowerCtrlGpio             = HAL_GPIO_9,                      \
        .systemAlive                 = HAL_GPIO_8,                      \
        .simDetectGpio               = HAL_GPIO_38, 					\
    }
...
#ifdef TGT_WITH_FM_MODEL_rdafm_8909
// =============================================================================
...
#endif //TGT_WITH_FM_MODEL_rdafm_8909
