...
#define  MSG_ID_JAT_TIMER_IND_0    	  ( COS_CSW_TIMER_ID_BASE + 64)
#define  MSG_ID_JAT_TIMER_IND_1    	  ( COS_CSW_TIMER_ID_BASE + 65)
#define  MSG_ID_JAT_TIMER_IND_2    	  ( COS_CSW_TIMER_ID_BASE + 66)
#define  MSG_ID_JAT_TIMER_IND_3    	  ( COS_CSW_TIMER_ID_BASE + 67)
#define  MSG_ID_JAT_TIMER_IND_4    	  ( COS_CSW_TIMER_ID_BASE + 68)
#define  MSG_ID_JAT_TIMER_IND_5    	  ( COS_CSW_TIMER_ID_BASE + 69)
#define  MSG_ID_JAT_TIMER_IND_6    	  ( COS_CSW_TIMER_ID_BASE + 70)
#define  MSG_ID_JAT_TIMER_IND_7    	  ( COS_CSW_TIMER_ID_BASE + 71)
#define  MSG_ID_JAT_TIMER_IND_8    	  ( COS_CSW_TIMER_ID_BASE + 72)
#define  MSG_ID_JAT_TIMER_IND_9    	  ( COS_CSW_TIMER_ID_BASE + 73)
#define  MSG_ID_TRANSP_TOMMI_IND      ( COS_CSW_TIMER_ID_BASE + 74)
#endif

//
//CSW Max timer
//
#define COS_CSW_TIMER_ID_XXX_END      ( COS_CSW_TIMER_ID_BASE + 75 )
