...
UINT32 CFW_GethostbynameEX(char *hostname, ip_addr_t *addr, UINT8 nCid, CFW_SIM_ID nSimID, COS_CALLBACK_FUNC_T func, VOID *param);
UINT32 CFW_GetallhostbynameEX(char *hostname, ip_addr_t *addr, UINT8 nCid, CFW_SIM_ID nSimID, COS_CALLBACK_FUNC_T func, VOID *param);
UINT32 CFW_TcpipSocketConnectEx(SOCKET nSocket,  CFW_TCPIP_SOCKET_ADDR *pName, UINT8 nNameLen, CFW_SIM_ID nSimID);
