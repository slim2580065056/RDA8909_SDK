...
uint16_t hal_GpadcReadEfuse(EFUSE_NUM efuseNum, EFUSE_BITS efuseBits);

PUBLIC VOID hal_GpadcEnableChannel(HAL_ANA_GPADC_CHAN_T channel);

PUBLIC VOID hal_GpadcDisenableChannel(HAL_ANA_GPADC_CHAN_T channel);

PUBLIC VOID hal_GpadcSetMinAtp(HAL_ANA_GPADC_ATP_T minAtp);

PUBLIC UINT16 hal_GpadcGetRawValue(HAL_ANA_GPADC_CHAN_T channel);

PUBLIC HAL_ANA_GPADC_MV_T hal_GpadcGetMVol(HAL_ANA_GPADC_CHAN_T channel);

void hal_GpadcSleep();
void hal_GpadcWakeup();
