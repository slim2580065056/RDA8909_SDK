...
extern UINT32 _boot_sys_sram_resume_txt_end;
...
extern UINT32 _nb_sram_stack_start;
extern UINT32 _nb_sram_stack_end;
...
// =============================================================================
// _irq_sram_flash_start_location
// -----------------------------------------------------------------------------
/// Start address of the flash image of the irq handler in the sram
// =============================================================================
extern UINT32 _irq_sram_flash_start_location;

// =============================================================================
// _irq_sram_flash_end_location
// -----------------------------------------------------------------------------
/// End address of the flash image of the irq handler in the sram
// =============================================================================
extern UINT32 _irq_sram_flash_end_location;

// =============================================================================
// _irq_sram_start
// -----------------------------------------------------------------------------
/// Start address of the irq handler in the sram
// =============================================================================
extern UINT32 _irq_sram_start;
...
/// Start address of the reserved space for the user data in flash
// =============================================================================
extern UINT32 _spiffs_user_data_start;
...
/// End address of the reserved space for the user data in flash
// =============================================================================
extern UINT32  _spiffs_user_data_end;
...
// =============================================================================
// _rdabt_firmware_data_{start/end}
// -----------------------------------------------------------------------------
/// bt firmware code in ram
// =============================================================================
extern UINT32 _rdabt_firmware_data_start;
extern UINT32 _rdabt_firmware_data_end;
