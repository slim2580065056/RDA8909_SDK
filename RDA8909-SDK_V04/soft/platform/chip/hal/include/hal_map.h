...
/// accessible through CoolWatcher (or any CoolXml tool). It is also used for
/// the get version mechanism.
...
typedef struct
{
    ...
    /// The next PXTS tag/time stamp will be read at this address by
    /// CoolWatcher. (Unused)
    ...
    /// Function to execute remotely to allocate the buffer used by the profile
    /// in RAM mechanism.
    VOID *mallocRamBuffer; //0x0000001C
    /// Function to execute remotely to free the buffer used by the profile in
    /// RAM mechanism.
...
#define HAL_PROFILE_CONTROL_T_GLOBAL_ENABLE_RAM_MASK (1 << 0)
#define HAL_PROFILE_CONTROL_T_GLOBAL_ENABLE_RAM_SHIFT (0)
#define HAL_PROFILE_CONTROL_T_GLOBAL_ENABLE_TRACE (1 << 1)
#define HAL_PROFILE_CONTROL_T_GLOBAL_ENABLE_TRACE_MASK (1 << 1)
#define HAL_PROFILE_CONTROL_T_GLOBAL_ENABLE_TRACE_SHIFT (1)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_0 (1 << 16)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_0_MASK (1 << 16)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_0_SHIFT (16)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BOOT (1 << 17)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BOOT_MASK (1 << 17)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BOOT_SHIFT (17)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_HAL (1 << 18)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_HAL_MASK (1 << 18)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_HAL_SHIFT (18)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SX (1 << 19)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SX_MASK (1 << 19)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SX_SHIFT (19)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_PAL (1 << 20)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_PAL_MASK (1 << 20)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_PAL_SHIFT (20)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_EDRV (1 << 21)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_EDRV_MASK (1 << 21)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_EDRV_SHIFT (21)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SVC (1 << 22)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SVC_MASK (1 << 22)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SVC_SHIFT (22)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_STACK (1 << 23)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_STACK_MASK (1 << 23)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_STACK_SHIFT (23)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_CSW (1 << 24)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_CSW_MASK (1 << 24)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_CSW_SHIFT (24)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_9 (1 << 25)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_9_MASK (1 << 25)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_9_SHIFT (25)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_10 (1 << 26)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_10_MASK (1 << 26)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_10_SHIFT (26)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_11 (1 << 27)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_11_MASK (1 << 27)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_RESERVED_11_SHIFT (27)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BB_IRQ (1 << 28)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BB_IRQ_MASK (1 << 28)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_BB_IRQ_SHIFT (28)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPAL (1 << 29)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPAL_MASK (1 << 29)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPAL_SHIFT (29)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPP (1 << 30)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPP_MASK (1 << 30)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPP_SHIFT (30)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPC (1 << 31)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPC_MASK (1 << 31)
#define HAL_PROFILE_CONTROL_T_ENABLE_PXTS_TAG_SPC_SHIFT (31)
...
#define HAL_PROFILE_CONTROL_T_WRAPPED_MASK (1 << 0)
#define HAL_PROFILE_CONTROL_T_WRAPPED_SHIFT (0)
#define HAL_PROFILE_CONTROL_T_OVERFLOWED (1 << 1)
#define HAL_PROFILE_CONTROL_T_OVERFLOWED_MASK (1 << 1)
#define HAL_PROFILE_CONTROL_T_OVERFLOWED_SHIFT (1)

// ============================================================================
// HAL_RFDIG_PROFILE_CONTROL_T
// -----------------------------------------------------------------------------
/// Profile control for RFDIG.
// =============================================================================
typedef struct
{
    /// Start Address of the Ram Buffer used to record RFDIG tags.
    UINT32 startAddr; //0x00000000
    /// It must be of a sized multiple of 32 bits.
    UINT32 size; //0x00000004
    /// The next RFDIG tag/time stamp will be written at this position
    UINT32 writePosition; //0x00000008
    /// Record count
    UINT32 count;              //0x0000000C
} HAL_RFDIG_PROFILE_CONTROL_T; //Size : 0x10
...
typedef struct
{
    ...
    HAL_RFDIG_PROFILE_CONTROL_T *rfdigProfileControl; //0x0000004C
} HAL_MAP_ACCESS_T;                                   //Size : 0x50

//config
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_RAM (1 << 0)
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_RAM_MASK (1 << 0)
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_RAM_SHIFT (0)
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_TRACE (1 << 1)
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_TRACE_MASK (1 << 1)
#define HAL_MAP_ACCESS_T_GLOBAL_ENABLE_TRACE_SHIFT (1)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_0 (1 << 16)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_0_MASK (1 << 16)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_0_SHIFT (16)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BOOT (1 << 17)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BOOT_MASK (1 << 17)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BOOT_SHIFT (17)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_HAL (1 << 18)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_HAL_MASK (1 << 18)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_HAL_SHIFT (18)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SX (1 << 19)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SX_MASK (1 << 19)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SX_SHIFT (19)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_PAL (1 << 20)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_PAL_MASK (1 << 20)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_PAL_SHIFT (20)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_EDRV (1 << 21)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_EDRV_MASK (1 << 21)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_EDRV_SHIFT (21)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SVC (1 << 22)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SVC_MASK (1 << 22)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SVC_SHIFT (22)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_STACK (1 << 23)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_STACK_MASK (1 << 23)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_STACK_SHIFT (23)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_CSW (1 << 24)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_CSW_MASK (1 << 24)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_CSW_SHIFT (24)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_9 (1 << 25)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_9_MASK (1 << 25)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_9_SHIFT (25)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_10 (1 << 26)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_10_MASK (1 << 26)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_10_SHIFT (26)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_11 (1 << 27)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_11_MASK (1 << 27)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_RESERVED_11_SHIFT (27)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BB_IRQ (1 << 28)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BB_IRQ_MASK (1 << 28)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_BB_IRQ_SHIFT (28)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPAL (1 << 29)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPAL_MASK (1 << 29)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPAL_SHIFT (29)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPP (1 << 30)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPP_MASK (1 << 30)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPP_SHIFT (30)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPC (1 << 31)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPC_MASK (1 << 31)
#define HAL_MAP_ACCESS_T_ENABLE_PXTS_TAG_SPC_SHIFT (31)
...
#define HAL_MAP_ACCESS_T_WRAPPED_MASK (1 << 0)
#define HAL_MAP_ACCESS_T_WRAPPED_SHIFT (0)
#define HAL_MAP_ACCESS_T_OVERFLOWED (1 << 1)
#define HAL_MAP_ACCESS_T_OVERFLOWED_MASK (1 << 1)
#define HAL_MAP_ACCESS_T_OVERFLOWED_SHIFT (1)
...
// =============================================================================
// hal_MapSetRfdigProfileControl
// -----------------------------------------------------------------------------
/// Set RFDIG profile control pointer.
// =============================================================================
PUBLIC VOID hal_MapSetRfdigProfileControl(VOID *pctrl);
