...
#define HAL_ENDIAN_LITTLE_32(X) (((((X) >> 24) & 0xFF) << 0) | ((((X) >> 16) & 0xFF) << 8) | ((((X) >> 8) & 0xFF) << 16) | ((((X) >> 0) & 0xFF) << 24))

#define HAL_ENDIAN_LITTLE_24(X) (((((X) >> 16) & 0xFF) << 0) | ((((X) >> 8) & 0xFF) << 8) | ((((X) >> 0) & 0xFF) << 16))

#define HAL_ENDIAN_LITTLE_16(X) (((((X) >> 8) & 0xFF) << 0) | ((((X) >> 0) & 0xFF) << 8))
...
#define HAL_ENDIAN_BIG_32(X) (((((X) >> 24) & 0xFF) << 0) | ((((X) >> 16) & 0xFF) << 8) | ((((X) >> 8) & 0xFF) << 16) | ((((X) >> 0) & 0xFF) << 24))

#define HAL_ENDIAN_BIG_24(X) (((((X) >> 16) & 0xFF) << 0) | ((((X) >> 8) & 0xFF) << 8) | ((((X) >> 0) & 0xFF) << 16))

#define HAL_ENDIAN_BIG_16(X) (((((X) >> 8) & 0xFF) << 0) | ((((X) >> 0) & 0xFF) << 8))
...
// =============================================================================
#define HAL_SYS_GET_RA(store) asm volatile("move %0, $31" \
                                           : "=r"((store)))
...
/// @param store The return value of the current function
// =============================================================================
#define HAL_SYS_GET_SP(store) asm volatile("move %0, $29" \
                                           : "=r"((store)))
...
/// @param store The return value of the current function
// =============================================================================
#define HAL_SYS_GET_K1(store) asm volatile("move %0, $27" \
                                           : "=r"((store)))
...
#define HAL_READ_REGISTER(reg)                 \
    do                                         \
    {                                          \
        unsigned POSSIBLY_UNUSED _val = (reg); \
    } while (0);

// =============================================================================
//  TYPES
// =============================================================================
#define HAL_SYS_MEM_DEFAULT_FREQ RAM_INIT_CLOCK_RATE
...
// =============================================================================
PUBLIC int hal_SysGetMetalId(VOID);
...
// =============================================================================
// hal_SysSuspend/hal_SysResume
// -----------------------------------------------------------------------------
/// APIs for cpu power off. At cpu power off, the last step is to call
/// hal_SysSuspend. And at wake up, hal_SysResume will return to the point at
/// power off. (clock and memory should be initialized beforehand)
// =============================================================================
PUBLIC VOID hal_SysSuspend(VOID);
PUBLIC VOID hal_SysResume(VOID);
