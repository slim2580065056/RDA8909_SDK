...
/// the on-off button.
// ============================================================================
typedef void (*HAL_KEY_IRQ_HANDLER_T)(uint8_t id, HAL_KEY_STATE_T status);
...
/// debounce time.
// ============================================================================
PUBLIC void hal_KeyOpen(uint16_t debounceTime, uint16_t kpItvTime);
...
// ============================================================================
PUBLIC void hal_KeyClose();

// ============================================================================
// hal_Key{Suspend/Resume}
// ----------------------------------------------------------------------------
/// These functions for keypad hardware suspend resume
// ============================================================================
PUBLIC void hal_KeySuspend();
PUBLIC void hal_KeyResume();
...
// ============================================================================
PUBLIC HAL_KEY_IRQ_MASK_T hal_KeyIrqGetMask();
...
///         \c FALSE otherwise
// ============================================================================
PUBLIC bool hal_KeyOnOffStateGet();
...
///         \c FALSE otherwise
// ============================================================================
PUBLIC bool hal_KeyOnOffStateAtPowerOn();
...
// =============================================================================
PUBLIC void hal_KeyRemoteHandler(uint32_t keyCode, HAL_KEY_STATE_T state);
