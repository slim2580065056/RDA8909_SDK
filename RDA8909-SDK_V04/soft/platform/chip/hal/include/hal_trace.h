...
// =============================================================================
// hal_HstTraceRequestDataTick
// -----------------------------------------------------------------------------
/// Request trace buffer (and fill header), and notify data have been filled.
/// And the tick count is return also.
///
/// @param id FlowId
/// @param size Size of data to be sent
/// @param tick Pointer for tick count, must be non-NULL.
/// @return NULL if no enough free buffer
// =============================================================================
UINT32 *hal_HstTraceRequestDataTick(UINT8 id, UINT16 size, unsigned *tick);
...
// =============================================================================
// hal_HstTraceSuspend/hal_HstTraceResume
// -----------------------------------------------------------------------------
/// APIs for suspend and resume
// =============================================================================
VOID hal_HstTraceSuspend();
VOID hal_HstTraceResume();
