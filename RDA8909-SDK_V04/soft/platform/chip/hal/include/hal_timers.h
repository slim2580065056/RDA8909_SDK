...
PUBLIC HAL_ERR_T hal_TimRtcGetRawTime(HAL_TIM_RTC_TIME_T *rtcTime);

#ifdef CHIP_DIE_8909
PUBLIC VOID hal_TimRtcCalib();
PUBLIC VOID hal_TimRtcCalib1S();
PUBLIC VOID hal_TimRtcCalibClr();
#endif
...
PUBLIC VOID hal_TimRtcAlarmIrqSetOsiHandler(HAL_TIM_RTC_ALARM_IRQ_HANDLER_T handler);
...
// hal_TimTickStart
// ----------------------------------------------------------------------------
/// Start the OS timer with init value
/// @param loadVal Initial value of the OS timer
// ============================================================================
PUBLIC VOID hal_TimTickStart(UINT32 loadVal);
...
// hal_TimSetUpTime
// -----------------------------------------------------------------------------
/// When it is known that HW timer is discontinued, this API can set an expected
/// up time.
///
/// @param tick Expected up time, in 16384Hz ticks.
// =============================================================================
PUBLIC VOID hal_TimSetUpTime(UINT32 tick);

// =============================================================================
// hal_TimAddHWTimerOffset
// -----------------------------------------------------------------------------
/// When it is known that HW timer is discontinued, this API can set the offset
/// during HW timer discontinue.
///
/// @param tick_offset Tick offset, in 16384Hz ticks.
// =============================================================================
PUBLIC VOID hal_TimAddHWTimerOffset(UINT32 tick_offset);
