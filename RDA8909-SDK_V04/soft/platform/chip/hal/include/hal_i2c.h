...
// ============================================================================
// hal_I2cSuspend/hal_I2cResume
// ----------------------------------------------------------------------------
/// The function suspend/resume i2c
/// Call them if enter/exit pm2 with i2c working
// ============================================================================
void hal_I2cSuspend(HAL_I2C_BUS_ID_T id);
void hal_I2cResume(HAL_I2C_BUS_ID_T id);
