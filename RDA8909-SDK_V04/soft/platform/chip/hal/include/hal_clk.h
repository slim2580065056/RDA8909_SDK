...
enum
{
    ...
    FOURCC_NBSTK = FOURCC('N', 'S', 'T', 'K'),
    FOURCC_LTEF8 = FOURCC('L', 'T', 'F', '8'),
    FOURCC_RTC = FOURCC('R', 'T', 'C', ' '),
#endif
};
...
enum
{
    ...
    // HAL_CLK_RATE_48M = 48000000,
    HAL_CLK_RATE_53M = 52363636, //288M/5.5
    HAL_CLK_RATE_57M = 57600000,
    HAL_CLK_RATE_64M = 64000000, //288M/4.5
    HAL_CLK_RATE_72M = 72000000,
    HAL_CLK_RATE_82M = 82285714, //288M/3.5
    // HAL_CLK_RATE_96M = (96 * 1000000),
    HAL_CLK_RATE_115M = 115200000, //288M/2.5
    HAL_CLK_RATE_144M = 144000000,
    HAL_CLK_RATE_192M = 192000000, //288M/1.5
    HAL_CLK_RATE_288M = 288000000,
};
#endif
...
uint8_t hal_ClkGetUseCount(HAL_CLK_T *clk);
