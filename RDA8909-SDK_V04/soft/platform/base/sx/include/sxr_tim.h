...
#define SXR_TIMER_MBX_MSK ((u16)0xFFF << SXR_TIMER_MBX_POS)

#define SXR_TIMER_FLAG_POS 12
#define SXR_TIMER_FLAG_MSK ((u16)0x3 << SXR_TIMER_FLAG_POS)
#define SXR_TIMER_FLAG_PM3 (1 << SXR_TIMER_FLAG_POS)
#define SXR_TIMER_FLAG_PM1 (2 << SXR_TIMER_FLAG_POS)
...
// =============================================================================
// sxr_TimerRemainByFlag
// -----------------------------------------------------------------------------
/// Check the remain period for the first timer with specified flag.
/// If the returned value will be used, it is needed to call this inside critical
/// section, because time/timer is always changing.
///
/// @param flags    Timer flags (PM1_TIMER, PM3_TIMER)
/// @return         0: already expired, -1U: not exist, others: remain period
// =============================================================================
u32 sxr_TimerRemainByFlag(u32 Flags);
...
void sxr_StartMbxTimerWithFlags(u32 Period, u32 *evt, u8 Mbx, u32 Flags);
